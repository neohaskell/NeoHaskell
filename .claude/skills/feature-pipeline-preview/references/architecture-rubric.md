...
The review-quality agent reads the produced architecture doc at `docs/architecture/<adr-number>-<slug>.md` plus the source ADR at `docs/decisions/<adr-number>-<slug>.md`. For each question:
