...
Produces `.integration-pipeline/findings-12.json` with grounded security findings against the actual implementation.
...
4. **Record** — read `./04-record/SKILL.md` and follow it, piping in the step 3 output. Verify: `.integration-pipeline/findings-12.json` exists and phase 12 is marked complete.
