...
1. `URL=$(python3 .claude/skills/integration-pipeline-preview/scripts/pipeline.py get pr_url)`.
2. `NUM=$(python3 .claude/skills/integration-pipeline-preview/scripts/pipeline.py get pr_number)`.
...
5. Run `python3 .claude/skills/integration-pipeline-preview/scripts/pipeline.py complete 17`.
