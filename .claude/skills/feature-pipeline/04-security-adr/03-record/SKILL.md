...
2. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py findings 4 .pipeline/findings-04.json`.
3. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py complete 4`.
