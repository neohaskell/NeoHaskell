...
Produces `.pipeline/findings-13.json` with grounded performance findings against the actual implementation.
...
4. **Record** — read `./04-record/SKILL.md` and follow it, piping in the step 3 output. Verify: `.pipeline/findings-13.json` exists and phase 13 is marked complete.
