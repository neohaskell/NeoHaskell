...
2. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py findings 13 .pipeline/findings-13.json`.
3. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py complete 13`.
