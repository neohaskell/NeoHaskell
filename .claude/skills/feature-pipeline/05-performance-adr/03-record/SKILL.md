...
2. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py findings 5 .pipeline/findings-05.json`.
3. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py complete 5`.
