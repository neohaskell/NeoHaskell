...
8. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py set pr_url "$URL"`.
9. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py set pr_number "$NUM"`.
10. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py complete 16`.
