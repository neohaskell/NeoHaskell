...
- `docs/architecture/<adr-number>-<slug>.md` — produced by phase 7.
...
4. Write the spec to `docs/architecture/<adr-number>-<slug>-tests.md` → verify: file exists with the sections in the Output contract.
...
`docs/architecture/<adr-number>-<slug>-tests.md` exists with the four sections above. Stdout is a single line: `wrote docs/architecture/<adr-number>-<slug>-tests.md`.
