...
- `../../references/test-spec-rubric.md` — the eight-check rubric + four Karpathy carrier rules.
...
6. On `pass`: run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py complete 8`; print `RUBRIC: pass`.
