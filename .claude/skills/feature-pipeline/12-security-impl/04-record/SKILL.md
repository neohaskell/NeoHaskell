...
2. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py findings 12 .pipeline/findings-12.json`.
3. Run `python3 .claude/skills/feature-pipeline/scripts/pipeline.py complete 12`.
