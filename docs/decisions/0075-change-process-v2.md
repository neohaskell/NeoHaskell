...
> Supersedes the 20-step `change` formula (retired 2026-08-20, preserved in
> the beads backup at `~/repos/archive/neohaskell-beads-backup-2026-08-20.tar.gz`)
> and completes the arc of [ADR-0067](0067-contract-delta-spec-gate.md) →
